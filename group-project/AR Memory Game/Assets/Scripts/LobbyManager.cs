...
public class LobbyManager : MonoBehaviour {
    ...
    private string m_SceneName = "BlankAR";

    public const string KEY_PLAYER_NAME = "ARPlayer";
    ...
    public async void Authenticate(string playerName) {
        ...
        AuthenticationService.Instance.SignedIn += () => {
            // do nothing
            Debug.Log("Signed in with pID: " + AuthenticationService.Instance.PlayerId);
...
public async void UpdatePlayerName(string playerName) {
    ...
    public async void UpdateLobbyGameMode(GameMode gameMode) {
        try {
            ...
            var lobby = await Lobbies.Instance.UpdateLobbyAsync(joinedLobby.Id, new UpdateLobbyOptions {
                Data = new Dictionary<string, DataObject> {
                    { KEY_GAME_MODE, new DataObject(DataObject.VisibilityOptions.Public, gameMode.ToString()) }
                }
            });
    ...
    public async void StartGame()
    {
        if (IsLobbyHost())
        {
            try
            {
                ...
                var status = NetworkManager.Singleton.SceneManager.LoadScene("BlankAR", LoadSceneMode.Single);
